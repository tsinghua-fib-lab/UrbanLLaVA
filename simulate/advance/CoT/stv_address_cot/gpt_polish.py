...
if __name__ == "__main__":
    ...
    parser.add_argument('--task', type=str, default='stv-address-cot', choices=['stv-address-cot'])
    ...
    og_path = os.path.join(work_dir, f'dev-{city}/CoT/{task}/{task}_{city}.json')
    ...
    with ThreadPoolExecutor(max_workers=128) as executor:
        ...
        for future in tqdm(futures):
            ...
            output.append({
                ...
                "near_feature": item['near_feature'],
            })

    output_path = f'polished_{task}_{city}.json'
    output_path = os.path.join(work_dir, f'dev-{city}/CoT/{task}', output_path)
