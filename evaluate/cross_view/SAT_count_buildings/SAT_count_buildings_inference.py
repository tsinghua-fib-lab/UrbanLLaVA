...
if __name__ == '__main__':
    ...
    parser.add_argument('--task_name', type=str, default='SAT_count_buildings', help='task name')
    ...
    for zl in ["zl15", "zl17"]:
        ...
        path = os.path.join(MULTI_IMAGE_FOLDER, task_name, city_name, f"{city_name}_{task_name}_{zl}_test.json")
