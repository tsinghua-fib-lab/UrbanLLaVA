...
if __name__ == '__main__':
    ...
    parser.add_argument('--task_name', type=str, default='STV_SAT_location', help='task name')
    ...
    path = os.path.join(MULTI_IMAGE_FOLDER, task_name, city, model_name, f"{city}_{task_name}_response.json")
    ...
    with open(os.path.join(stats_folder, f"{task_name}_{city}_{model_name}.json"), "w") as f:
        json.dump({
